...
<b-container>
            ...
            <div class=" row mx-5 justify-content-around">
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <div class="row my-4 mx-1 justify-content-around">
                        <b-button class="btn btn-block btn-primary" type="submit" style="font-size: 17px; background-color: rgb(19, 86, 230);">
                            로그인
                        </b-button>
                    </div>
                    <div>
        ...
        <div class="row my-3 justify-content-around">
            <b-button variant="outline-secondary" style="font-size: 15px; width: 400px;">
